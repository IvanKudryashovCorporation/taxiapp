...
$ip = (Get-NetIPAddress -AddressFamily IPv4 |
       ...
       # Среди 192.168.x.x берём тот у которого есть шлюз (Wi-Fi/Ethernet, не Hotspot)
       ForEach-Object {
