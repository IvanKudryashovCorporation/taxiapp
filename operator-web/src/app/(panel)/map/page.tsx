...
// Карта на 100% (минус sidebar/topbar). Floating-панель слева с фильтрами и счётчиком.
// Использует AppMap (общая карта со стилем из shared/map/style.js).
"use client";
